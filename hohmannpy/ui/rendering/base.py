...
# TODO: Change how rendering is handled so that you can have a variety of windows: groundtrack, coverage, orbit
#  controlled via one master render engine. This would allow both static and dynamic groundtrack renditions.
class RenderEngine:
    r"""
